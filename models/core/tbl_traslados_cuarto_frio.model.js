...
class TrasladoCuartoFrioModel extends Model {}

TrasladoCuartoFrioModel.init({
    ...
    whs_origen: { type: DataTypes.STRING(20), allowNull: false },
    whs_destino: { type: DataTypes.STRING(20), allowNull: false },
    ...
    sequelize: sequelize,
    tableName: 'tbl_traslados_cuarto_frio',
    schema: 'logistica',
    timestamps: false
});

module.exports = TrasladoCuartoFrioModel;